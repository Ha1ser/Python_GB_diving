...
date_to_prov = '15.04.10000'
print(is_valid_date(date_to_prov))
date_to_prov_2 = '01.13.2100'
print(is_valid_date(date_to_prov_2))
date_to_prov = '32.11.2011'
print(is_valid_date(date_to_prov))
date_to_prov_2 = '29.02.2000'
print(is_valid_date(date_to_prov_2))
date_to_prov = '29.02.2023'
print(is_valid_date(date_to_prov))
date_to_prov_2 = '28.02.2100'
print(is_valid_date(date_to_prov_2))